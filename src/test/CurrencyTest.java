...
public class CurrencyTest {
    ...
    private static @NotNull Stream<Arguments> testCorrectEndings() {
        return Stream.of(
                ...
                Arguments.of(100, "рублей"),
                Arguments.of(121, "рубль"),
                Arguments.of(123, "рубля"),
                Arguments.of(129, "рублей"),
                Arguments.of(130, "рублей"),
                Arguments.of(1578, "рублей"),
                Arguments.of(2631, "рубль"),
                Arguments.of(3472, "рубля"),
                Arguments.of( 4539, "рублей")
